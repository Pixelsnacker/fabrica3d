...
INSERT INTO `site_images` (`imageKey`, `labelDe`, `url`, `filename`) VALUES
...
('cad_reverse', 'CAD Reverse Engineering – Hero-Bild', 'https://d2xsxph8kpxj0f.cloudfront.net/310419663031764330/hjDE334DRgUQ9x8faFXbRG/hero_reverse_engineering_panorama-ZktQwSqLTcuGMggkpygyBK.webp', 'hero_reverse_engineering_panorama.webp'),
...
ON DUPLICATE KEY UPDATE `imageKey` = `imageKey`;
