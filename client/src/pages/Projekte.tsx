...
const projects = [
  ...
  { id: 2, title: 'Reverse Engineering Ersatzteil', titleEn: 'Reverse Engineering Spare Part', category: 'CAD', categoryEn: 'CAD', tech: 'Reverse Engineering + FDM', material: 'PA12', desc: 'Digitalisierung und Neukonstruktion eines veralteten Maschinenteils ohne vorhandene Zeichnung.', descEn: 'Digitization and reconstruction of an obsolete machine part without existing drawing.', image: 'https://d2xsxph8kpxj0f.cloudfront.net/310419663031764330/hjDE334DRgUQ9x8faFXbRG/proj_cad_reverse_4bdcaf6c.jpg' },
  { id: 3, title: 'Maßprüfung Serienteil', titleEn: 'Series Part Inspection', category: '3D-Scan', categoryEn: '3D Scan', tech: 'GOM ATOS', material: '–', desc: 'Qualitätskontrolle von 500 Serienteilen mit GOM ATOS. Vollständige Prüfdokumentation mit Farbplot.', descEn: 'Quality control of 500 series parts with GOM ATOS. Complete inspection documentation with color plot.', image: 'https://d2xsxph8kpxj0f.cloudfront.net/310419663031764330/hjDE334DRgUQ9x8faFXbRG/proj_scan_series_0afe91fb.jpg' },
  ...
  { id: 9, title: 'MJF Serienteile Konsumgüter', titleEn: 'MJF Series Parts Consumer Goods', category: '3D-Druck', categoryEn: '3D Printing', tech: 'MJF', material: 'PA12', desc: 'Serienfertigung von 1000 Funktionsteilen mit isotropen Eigenschaften in 5 Tagen.', descEn: 'Series production of 1000 functional parts with isotropic properties in 5 days.', image: 'https://d2xsxph8kpxj0f.cloudfront.net/310419663031764330/hjDE334DRgUQ9x8faFXbRG/proj_mjf_series_f3446f0f.jpg' },
