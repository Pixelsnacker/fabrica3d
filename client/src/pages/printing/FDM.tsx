...
export default function FDM() {
  ...
  return (
    <TechPageLayout
      ...
      heroImage={imgData?.url ?? 'https://d2xsxph8kpxj0f.cloudfront.net/310419663031764330/hjDE334DRgUQ9x8faFXbRG/fdm_industrial_printer_markforged_fx20_8cfeacca.jpg'}
