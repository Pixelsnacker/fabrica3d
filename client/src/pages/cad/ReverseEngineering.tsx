...
export default function ReverseEngineering() {
  const { data: imgData } = trpc.images.getByKey.useQuery({ imageKey: 'cad_reverse' }, { staleTime: 5 * 60 * 1000, retry: false });
  const { t } = useLanguage();
  return (
    <TechPageLayout
      ...
      heroImage={imgData?.url ?? 'https://d2xsxph8kpxj0f.cloudfront.net/310419663031764330/hjDE334DRgUQ9x8faFXbRG/hero_reverse_engineering_panorama-ZktQwSqLTcuGMggkpygyBK.webp'}
