...
export default function GomAtos() {
  const { data: imgData } = trpc.images.getByKey.useQuery({ imageKey: 'scan_gomatos' }, { staleTime: 5 * 60 * 1000, retry: false });
  const { t } = useLanguage();
  return (
    <TechPageLayout
